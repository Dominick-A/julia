...
unsafe_load(p::Ptr, i::Integer=1, align::Integer=1) = pointerref(p, Int(i), Int(align))
unsafe_store!(p::Ptr{Any}, x::ANY, i::Integer=1, align::Integer=1) = pointerset(p, x, Int(i), Int(align))
unsafe_store!{T}(p::Ptr{T}, x, i::Integer=1, align::Integer=1) = pointerset(p, convert(T,x), Int(i), Int(align))
